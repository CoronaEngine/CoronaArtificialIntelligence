...
def warmup_http_clients() -> None:
    ...
    """
    try:
        from models.client_image import (
    ...
    try:
        from models.client_speech import (
    ...
    try:
        from models.client_music import (
...
def warmup_tools() -> None:
    ...
    - 包括内置工具（media/text/scene）和外部工具（InnerAgentWorkflow/ai_tools）
...
def warmup_agent() -> None:
    ...
    """
    try:
        from agent.executor import create_default_agent
